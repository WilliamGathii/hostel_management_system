...
| Method | Endpoint | Purpose | Allowed Roles | Main Request Fields | Main Response Fields | Validation Rules | Status Codes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `GET` | `/api/v1/rooms` | List rooms. | Admin | Query filters | `rooms`, `pagination` | Filters must be valid. | `200`, `401`, `403`, `500` |
| `GET` | `/api/v1/rooms/:roomId` | View room details. | Admin | `roomId` path value | `room` | Room must exist. | `200`, `401`, `403`, `404`, `500` |
| `POST` | `/api/v1/rooms` | Create a room. | Admin | `room_number`, `room_type`, `capacity`, `floor`, `description` | `room` | Room number must be unique. Capacity must be positive. | `201`, `400`, `401`, `403`, `409`, `422`, `500` |
| `PATCH` | `/api/v1/rooms/:roomId` | Update room details. | Admin | `room_type`, `capacity`, `floor`, `description` | `room` | Room must exist. Capacity cannot be below current occupancy. | `200`, `400`, `401`, `403`, `404`, `422`, `500` |
| `PATCH` | `/api/v1/rooms/:roomId/status` | Update room status. | Admin | `status` | `room` | Status must be approved. | `200`, `400`, `401`, `403`, `404`, `422`, `500` |
...
| `POST` | `/api/v1/allocations` | Allocate a student to a room. | Admin | `student_id`, `room_id`, `start_date`, `expected_end_date`, `notes` | `allocation` | Student must not have another active allocation. Room capacity must be available. | `201`, `400`, `401`, `403`, `404`, `409`, `422`, `500` |
...
| `GET` | `/api/v1/reports/rooms` | View room availability, occupancy, and allocation reports. | Admin | Query filters | `room_report` | Filters must be valid. | `200`, `401`, `403`, `500` |
